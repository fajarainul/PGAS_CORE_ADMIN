      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> FORM ADD DATA LINK</h3>
            <?php
            ...
            <?php 
              $action = 'type_link='.$type_link;
            ?>
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Add Data Link ==> <?php echo $name_link;?></h4>
                      <form class="form-horizontal style-form" method="POST" action="add_link.php?<?php echo $action;?>">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Closure Name</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" placeholder="Closure Name" name="form_closure_name" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Latitude</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" placeholder="Latitude" name="form_latitude" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Longitude</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" placeholder="Longitude" name="form_longitude" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jarak</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" placeholder="Jarak" name="form_jarak" required>
                              </div>
                          </div>
                          <div class="form-group">
